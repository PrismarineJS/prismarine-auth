 ...
 * @property {string} username - The email of the microsoft/xbox account.
 * @property {string} [password] - The password of the microsoft/xbox account. You may omit this to use device code over password-based authentication.
 * @property {string} [cacheDirectory] - The full path of where you want to store your tokens for later use.
 * @property {function} [onMsaCode] - A function to be called when we recieve the microsoft authentication code.
 * @property {string} [authTitle] -  The title key for the application we are authenticating with. Used for Nintendo Switch/Bedrock Clients.
 */

/**
 * @typedef {Object} AuthenticationResponse
 * @property {(string|null)} userXUID
 * @property {string} userHash
 * @property {string} XSTSToken
 * @property {string} expiresOn
 */

/**
 * Authenticate with Microsoft to fetch an Xbox XSTS Token used for authenticating with Xbox Live.
 * @function
